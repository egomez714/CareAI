export const patients = [
  ...
  },
  {
    ...
    mood: 'declining',
    riskLevel: 'Medium',
    notes: 'Wenqing is struggling with morning energy levels. AI checkup needed mid-week.',
    avatarUrl: 'https://ui-avatars.com/api/?name=Wenqing+Li&background=f5f5f4&color=57534e&size=150',
    aiCalls: 5,
    missedCalls: 1,
    phone: '+18056703413',
    upcomingSessions: [
  ...
  },
  {
    ...
    avatarUrl: 'https://ui-avatars.com/api/?name=Christopher+Hernandez&background=f5f5f4&color=57534e&size=150',
    aiCalls: 1,
    missedCalls: 0,
    phone: '+18056703413',
    upcomingSessions: [
  ...
  },
  {
    ...
    mood: 'anxious',
    riskLevel: 'High',
    notes: 'Reported high anxiety yesterday. Scheduled immediate AI follow-up.',
    avatarUrl: 'https://ui-avatars.com/api/?name=Serafim+Sharkov&background=f5f5f4&color=57534e&size=150',
    aiCalls: 0,
    missedCalls: 3,
    phone: '+18056703413',
    upcomingSessions: [
